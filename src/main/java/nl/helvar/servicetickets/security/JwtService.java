...
import nl.helvar.servicetickets.exceptions.JwtTokenExpiredException;
...
public class JwtService {
    private final static String SECRET_KEY = "thisisyourauthenticationtousetheserviceticketapplication";
